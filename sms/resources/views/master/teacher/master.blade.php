            ...
            <div class="d-flex">
                ...
                <div class="dropdown d-inline-block">
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        ...
                        <form action="{{'user-logout'}}" method="POST" id="teacherLogoutForm">
                            @csrf
                        </form>
                    </div>
                </div>
            ...
            <div id="sidebar-menu">
                ...
                <ul class="metismenu list-unstyled" id="side-menu">
                    ...
                    <li>
                        ...
                        <ul class="sub-menu" aria-expanded="false">
                            <li><a href="ecommerce-products.html">Approved Courses</a></li>
                            <li><a href="ecommerce-product-detail.html">Denied Courses</a></li>
                            <li><a href="ecommerce-product-detail.html">Enrolled Students</a></li>
                        </ul>
                    </li>
